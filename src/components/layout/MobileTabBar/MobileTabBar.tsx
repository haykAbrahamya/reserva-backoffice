...
export function MobileTabBar() {
  ...
  return (
    <>
      ...
      {moreOpen && (
        <>
          <div className={s.moreScrim} onClick={() => setMoreOpen(false)} />
          <div className={s.moreSheet}>
            ...
            <div className={s.sheetItems}>
              <button
                ...
                onClick={() => { setMoreOpen(false); navigate('/clients') }}
              >
              ...
              <button
                className={s.sheetItem}
                onClick={() => { setMoreOpen(false); navigate('/specialists') }}
              >
                <span className={s.sheetItemIcon}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <button
                className={s.sheetItem}
                onClick={() => { setMoreOpen(false); navigate('/hours') }}
              >
                <span className={s.sheetItemIcon}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
